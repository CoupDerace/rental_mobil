...
class PaymentsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => sl<PaymentProvider>()..fetchPayments(),
      child: Consumer<PaymentProvider>(
        builder: (context, provider, child) {
          return AppScaffold(
            title: "Master Data Pembayaran",
              ...
              child: ListView(
                ...
                children: [
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Kelola data transaksi pembayaran rental mobil",
                    ...
                    child: Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: "Cari Pembayaran (Pelanggan, Mobil, Metode, Status)...",
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "Menampilkan ${provider.paginatedPayments.length} dari ${provider.filteredPayments.length} Pembayaran",
                        style: theme.textTheme.bodySmall?.copyWith(
                          color: theme.colorScheme.onSurface.withValues(alpha: 0.6),
                          fontFamily: 'Inter',
                        ),
    ...
    showDialog(
      ...
      builder: (ctx) => ChangeNotifierProvider.value(
        ...
        child: const AlertDialog(
          title: Text("Tambah Pembayaran Baru"),
