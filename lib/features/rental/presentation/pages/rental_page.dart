...
import '../widgets/rental_table.dart';
...
class RentalPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => sl<RentalProvider>()..fetchRentals(),
      child: Consumer<RentalProvider>(
        builder: (context, provider, child) {
          return AppScaffold(
            title: "Master Data Rental",
            floatingActionButton: isAdmin ? FloatingActionButton.extended(
              onPressed: () => _showAddDialog(context, provider),
              icon: const Icon(Icons.add),
              label: const Text("Tambah Rental"),
              ...
              child: ListView(
                ...
                children: [
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Kelola data transaksi rental mobil pelanggan",
                    ...
                    child: Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: "Cari Rental (Pelanggan, Mobil, Plat, Status)...",
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "Menampilkan ${provider.paginatedRentals.length} dari ${provider.filteredRentals.length} Rental",
                        style: theme.textTheme.bodySmall?.copyWith(
                          color: theme.colorScheme.onSurface.withValues(alpha: 0.6),
                          fontFamily: 'Inter',
                        ),
  ...
  void _showAddDialog(BuildContext context, RentalProvider provider) {
    showDialog(
      context: context,
